...
var UsersRouter = exports.UsersRouter = function (_ClassesRouter) {
  ...
  _createClass(UsersRouter, [{
    ...
    value: function handleMe(req) {
      ...
      return _rest2.default.find(req.config, _Auth2.default.master(req.config), '_Session', { _session_token: sessionToken }, { include: 'user' }).then(function (response) {
    ...
    value: function handleLogOut(req) {
      ...
      if (req.info && req.info.sessionToken) {
        return _rest2.default.find(req.config, _Auth2.default.master(req.config), '_Session', { _session_token: req.info.sessionToken }).then(function (records) {
