...
var MongoCollection = function () {
  ...
  _createClass(MongoCollection, [{
    ...
    value: function findOneAndUpdate(query, update) {
      ...
      return this._mongoCollection.findAndModify(query, [], update, { new: true }).then(function (document) {
    ...
    value: function findOneAndDelete(query) {
      ...
      return this._mongoCollection.findAndRemove(query, []).then(function (document) {
        // Value is the object where mongo returns multiple fields.
        return document.value;
      });
    }
